...
class UploadHandler
{
    ...
    public function handleUpload($uploadDirectory, $name = null)
    {
        ...
        // Save a chunk
        $totalParts = isset($_REQUEST['qqtotalparts']) ? (int)$_REQUEST['qqtotalparts'] : 1;
        //Not get qquuid create folder 10-06-2016
        ...
        if ($totalParts > 1) {
            ...
            # non-chunked upload
            $albumname = RemoveUnicode::stripUnicode($_REQUEST['albumname']);
            $filename = RemoveUnicode::stripUnicode($name);
            $target = join(DIRECTORY_SEPARATOR, array($uploadDirectory, $albumname, $filename));
